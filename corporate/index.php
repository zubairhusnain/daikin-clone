...
<div class="g-main main-contents">
  <div class="g-container">
    ...
    <div class="bnr-brand"><a href="/corporate/air/">
      ...
      <div class="g-carousel_inner">
        ...
        <div class="g-media-v">
          <div class="g-media_left">
            <a href="/corporate/air/daikin_brand/glance/" class="g-hover">
          ...
          <div class="g-media_body">
            ...
            <a href="/corporate/air/daikin_brand/glance/" class="g-btn g-btn-em g-btn-inline">Learn More</a>
          </div>
        </div>
        <div class="g-media-v">
          <div class="g-media_left">
            <a href="/corporate/air/stories/" class="g-hover">
          ...
          <div class="g-media_body">
            ...
            <a href="/corporate/air/stories/" class="g-btn g-btn-em g-btn-inline">Learn More</a>
          </div>
        </div>
        <div class="g-media-v">
          <div class="g-media_left">
            <a href="/corporate/air/daikin_techknowledge/benefits/" class="g-hover">
          ...
          <div class="g-media_body">
            ...
            <a href="/corporate/air/daikin_techknowledge/benefits/" class="g-btn g-btn-em g-btn-inline">Learn More</a>
          </div>
        </div>
        <div class="g-media-v">
          <div class="g-media_left">
          ...
          <div class="g-media_body">
            ...
            <a href="no-page/" class="g-btn g-btn-em g-btn-inline">Learn More</a>
          </div>
        </div>
        <div class="g-media-v">
          <div class="g-media_left">
  ...
  <div class="g-container">
    ...
    <div class="g-grid g-grid-2 g-block grid-design">
      <div class="g-grid_el">
        <div class="g-media-v">
          <div class="g-media_left"><a href="no-page/" class="g-hover"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/corporate/images/design-jpg.jpg" alt="Image:DAIKIN design" /></a></div>
          <div class="g-media_body">
      ...
      <div class="g-grid_el">
        <div class="g-media-v">
          <div class="g-media_left"><a href="no-page/" class="g-hover"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/corporate/images/tic-jpg.jpg" alt="Image:Technology and Innovation Center" /></a></div>
          <div class="g-media_body">
  ...
  <div class="g-container">
    <div class="g-grid g-grid-2c g-block grid-corporate">
      ...
      <div class="g-grid_el">
        ...
        <a href="/corporate/corporate/overview/" class="g-btn g-btn-em g-btn-inline">Learn More</a>
        <ul class="g-grid g-grid-2">
          <li class="g-grid_el"><a href="/corporate/corporate/overview/message/" class="g-link">Message from Management</a></li>
          <li class="g-grid_el"><a href="/corporate/corporate/overview/philosophy/" class="g-link">Daikin Group Philosophy</a></li>
          <li class="g-grid_el"><a href="no-page/" class="g-link">Corporate Governance</a></li>
          <li class="g-grid_el">
            <!--2024.05 add-->
            <a href="no-page/" class="g-link">Behaviors</a>
            <!--2024.05 add-->
          </li>
          <li class="g-grid_el"><a href="no-page/" class="g-link">Management</a></li>
          <li class="g-grid_el"><a href="no-page/" class="g-link">Corporate Data</a></li>

          <li class="g-grid_el"><a href="no-page/" class="g-link">Business Guide</a></li>
          <li class="g-grid_el"><a href="no-page/" class="g-link">History</a></li>
          <li class="g-grid_el g-disp-pc"></li>　<!---下記の内容を左詰めにしたい為、追加してます。下記の内容以下に追加する際は、この行を削除してください。-->
          <li class="g-grid_el"><a href="no-page/" class="g-link">Group Companies</a></li>
          <li class="g-grid_el g-disp-pc"></li>　<!---下記の内容を左詰めにしたい為、追加してます。下記の内容以下に追加する際は、この行を削除してください。-->
          <li class="g-grid_el"><a href="/corporate/ip/" class="g-link">Initiatives For Intellectual Properties</a></li>
        </ul>
      </div>
    </div>
  </div>
