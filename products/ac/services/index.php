...
<div class="g-grid g-grid-3 g-block g-mb-40">
    <div class="g-grid_el">
        ...
        <a rel="noopener noreferrer" target="_blank" href="https://daikinreefer.my.site.com/rcp/" class="g-link g-blank">Go to website</a>
    </div>
    <div class="g-grid_el">
        <h3 class="g-ttl-3">Marine HVAC Service</h3>
        <p>Visit here for marine HVAC and engineering designs.</p>
        <a rel="noopener noreferrer" target="_blank" href="http://www.daikin.co.jp/group/dmre/english/index.html" class="g-link g-blank">Go to website</a>
    </div>
    <div class="g-grid_el">
        <h3 class="g-ttl-3">Member Portal Site</h3>
        <p>This site provides various technical materials to existing distributors.</p>
        <a rel="noopener noreferrer" target="_blank" href="https://global1d.daikin.com/business_portal/login/" class="g-link g-blank">Go to website</a>
    </div>
</div>
