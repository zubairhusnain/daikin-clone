...
<link rel="canonical" href="//www.daikin.com/products/ac/lineup/split_multi_split">
  ...
  <meta charset="utf-8">  <title>Split/Multi-Split Type Air Conditioners | Offers superior performance, energy-efficiency, and comfort in    stylish solutions conforming to all interior spaces and lifestyles | Air Conditioning and Refrigeration | Daikin    Global</title>    <meta name="description" content="">  <meta name="keywords" content="Split, Multi-Split, Air Conditioning, Refrigeration, HVAC, Air Conditioner, Products, Daikin, Daikin Industries">  <meta name="viewport" content="width=device-width,initial-scale=1">  <meta http-equiv="X-UA-Compatible" content="IE=edge">    <meta property="og:title" content="Split/Multi-Split Type Air Conditioners | Offers superior performance, energy-efficiency, and comfort in stylish solutions conforming to all interior spaces and lifestyles | Air Conditioning and Refrigeration | Daikin Global">  <meta property="og:description" content="">  <meta property="og:image" content="-/media/Project/Daikin/daikin_com/dg_common/images/og png"><!-- Google Tag Manager -->
...
<script>var __uzdbm_1 = "876471a0-c9ff-428a-a85e-7f7f6cfa1d1b";var __uzdbm_2 = "Y2ZlODBiODgtZG0waS00NGJmLWExOTQtOTA1ZGE5Zjc0OGQ5JDE4Mi4xNzcuODkuMTA5";var __uzdbm_3 = "7f9000ec5fa36b-18d0-433b-b71d-744b13763ae21-17801647746941085672-001084b923d3c5ff9e6250";var __uzdbm_4 = "false";var __uzdbm_5 = "uzmx";var __uzdbm_6 = "7f9000d40e2412-cf75-45b7-875a-44740772c2921-17801647746941085672-98355fe86bceb3b3250";var __uzdbm_7 = "daikin.com";</script> <script>   (function (w, d, e, u, c, g, a, b) {     w["SSJSConnectorObj"] = w["SSJSConnectorObj"] || {       ss_cid: c,       domain_info: "auto",     };     w[g] = function (i, j) {       w["SSJSConnectorObj"][i] = j;     };     a = d.createElement(e);     a.async = true;     if (       navigator.userAgent.indexOf('MSIE') !== -1 ||       navigator.appVersion.indexOf('Trident/') > -1     ) {       u = u.replace("/advanced/", "/advanced/ie/");     }     a.src = u;     b = d.getElementsByTagName(e)[0];     b.parentNode.insertBefore(a, b);   })(     window, document, "script", "assets/www.daikin.com/18f5227b-e27b-445a-a53f-f845fbe69b40/stormcaster.js", "dm0k", "ssConf"   );   ssConf("c1", "https://www.daikin.com");   ssConf("c3", "c99a4269-161c-4242-a3f0-28d44fa6ce24");   ssConf("au", "daikin.com");   ssConf("cu", "validate.perfdrive.com, ssc"); </script> <script type="text/javascript" async="" src="/products/ac/lineup/split_multi_split/assets/fast.fonts.net/lt/trackingCode.js/"></script><link type="text/css" rel="stylesheet" href="/products/ac/lineup/split_multi_split/assets/fast.fonts.net/lt/1.css/"><link type="text/css" rel="stylesheet" href="/products/ac/lineup/split_multi_split/assets/fast.fonts.net/lt/1.css/"><script type="text/javascript" charset="UTF-8" src="/products/ac/lineup/split_multi_split/assets/maps.googleapis.com/maps-api-v3/api/js/65/2d/intl/ja_ALL/common.js/"></script><script type="text/javascript" charset="UTF-8" src="/products/ac/lineup/split_multi_split/assets/maps.googleapis.com/maps-api-v3/api/js/65/2d/intl/ja_ALL/util.js/"></script></head>
...
<ul>
    ...
    <li class="is-Current"><a href="/products/">PRODUCTS &amp; SERVICES</a></li>
...
<!--/probo_noindex-->
    ...
    <div id="g-main" class="g-main">
      ...
      <div class="g-breadcrumbs">
        <ol>
          <li><a href="/products/ac/lineup/split_multi_split/">Top</a></li>
          <li><a href="/products/ac/lineup/split_multi_split/products/">Products &amp; Services</a></li>
          <li><a href="/products/ac/lineup/split_multi_split/products/ac/">Air Conditioning &amp; Refrigeration</a></li>
          <li>Split/Multi-Split Type Air Conditioners</li>
        </ol>
      </div>
      <div class="g-poster-hero--s">
        <div style="background-image:url('assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/lineup/split_multi_split/images/keyvisual_202303-png.png');background-size:cover;background-position:center center;" class="g-poster-hero_inner"><img class="g-poster-hero_img" src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/lineup/split_multi_split/images/keyvisual_202303-png.png" alt=""></div>
        <div class="g-poster-hero_hd">
          <h1><span>Split/Multi-Split Type</span>
...
<div class="g-column">
	<div class="g-media-h g-media-mq">
		<div class="g-media_left g-width-30"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/lineup/split_multi_split/images/pic_summary_01_202303_1.png" alt=""> </div>
		<div class="g-media_body">
			<p class="g-p">Daikin’s split and multi-split type air conditioning systems offer superior performance,
				energy-efficiency, and comfort in stylish solutions conforming to all interior spaces and lifestyles.
				An extensive product lineup utilizes Daikin technology for lower costs and environmental impact.</p>
		</div>
	</div>
</div>
<!---region select--->
	...
	<div class="region_select">
		<div class="select_wrap">
			<select id="dropdown1" class="dropdown">
				...
				<option value="https://www.daikin-argentina.com/equipos-residenciales/">Argentina</option>
				<option value="https://www.daikin.com.au/products/residential">Australia</option>
				<option value="https://www.daikin.com.br/produtos/residencial">Brazil</option>
				<option value="https://daikin-airconditioning.com.kh/en-gb/catalog/residensial-product/room-air">Cambodia</option>
				...
				<option value="https://www.daikinindia.com/product-category/splitac">India</option>
				<option value="https://www.daikin.co.id/ac-perumahan">Indonesia</option>
				...
				<option value="https://www.daikin.com.mm/products/wall-mounted-series">Myanmar</option>
				...
				<option value="https://www.daikin.com.ph/products/room-air/">Philippines</option>
				<option value="https://www.daikin.com.sg/products/residential">Singapore</option>
				<option value="https://www.hotaidev.com.tw/web/product/1.html">Taiwan</option>
				<option value="https://www.daikin.co.th/en/category/ResidentialProduct#tabCategoryRoomAir">Thailand</option>
...
<div class="g-grid g-grid-2 g-block g-mb-40">
	<div class="g-grid_el">
		<h3 class="g-ttl-3">Individual Control</h3>
		<p>Each indoor unit can be operated independently to deliver air comfort only to rooms where needed.</p>
	</div>
	<div class="g-grid_el">
		<h3 class="g-ttl-3">Energy and Cost Savings</h3>
		<p>Advanced inverter and heat pump technologies achieve greater efficiency and energy-savings at lower
			costs.</p>
	</div>
	<div class="g-grid_el">
		<h3 class="g-ttl-3">Flexible Installation</h3>
		<p>Daikin compact split/multi-split air conditioners easily install to residences where space is limited.
		</p>
	</div>
	<div class="g-grid_el">
		<h3 class="g-ttl-3">Extensive Product Lineup</h3>
		<p>A broad array of models allows the perfect match of style and performance to any interior space.</p>
	</div>
</div>
...
<div class="g-grid g-grid-2 g-block g-mb-40">
	<div class="g-grid_el"> <img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/lineup/split_multi_split/images/pic_overview_01_202303_1.png" alt="" class="g-img">
		<h2 class="g-ttl-2">Split</h2>
		<ul class="g-blist">
			<li>Connects one indoor unit to an outdoor unit.</li>
			<li>Installs simply and unobtrusively to buildings with no need for ductwork.</li>
			<li>Delivers a sophisticated air conditioning solution to single zone interior spaces at an affordable
				price.</li>
			<li>Provides a simple solution for one-room additions.</li>
		</ul>
	</div>
	<div class="g-grid_el"> <img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/lineup/split_multi_split/images/pic_overview_02.jpg" alt="" class="g-img">
		<h2 class="g-ttl-2">Multi-split</h2>
		<ul class="g-blist">
			<li>Connects up to five indoor units to a single outdoor unit.</li>
			<li>Installs a complete air conditioning system to multiple zone interior spaces with no need for
				ductwork.</li>
			<li>Provides individual control of room temperature settings.</li>
			<li>Enables indoor units of different styles and capacities in one system for customized solutions
				unique to each residential setting.</li>
		</ul>
	</div>
</div>
<div class="g-section-lv2">
...
<p>Compact size and ease of installation make split and multi-split air conditioners the popular choice for
	new construction and renovation projects. Utilizing our own unique cutting-edge technology, Daikin further
	raises the bar with high-capacity air conditioners offering unrivaled performance and energy-savings.</p>
<div class="g-grid g-grid-3 g-grid-keep g-block g-mb-40">
...
<!---region select--->
    ...
    <div class="g-mb-40">
            ...
            <div class="g-section-lv2">
              <h2 class="g-ttl-2">Technology</h2>
            </div>
            <p>Providing the latest in air comfort technology is Daikin’s mission. Consult your nearest Daikin
              representative to learn what special features are built into the models in your area.</p>



<h3 class="g-ttl-3">Inverter Technology</h3>
<p>Air conditioner compressors are driven by motor, and motor rotation speed depends on power supply frequency. An inverter modulates power supply frequency to control motor rotation speed. Inverters stabilize temperature by adjusting compressor operation according to load to eliminate waste and save energy.</p>
<p>Even adopting an inverter to the fan motors of the indoor and outdoor units provides more precise control and contributes to energy savings.</p>
<div class="g-column">
 <h2 class="g-ttl-2">Temperature Control by Inverter/Non-Inverter Compressors (Cooling)</h2>
 <div class="g-talign-r g-mb-10"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/common/images/tooltip_technologies_notes-png.png" alt=""></div>
 <img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/common/images/tooltip_technologies-png.png" alt="" class="g-img">
 <div class="g-grid g-grid-2 g-block">
  <div class="g-grid_el">
   <div class="g-media-h">
    <div class="g-media_left"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/common/images/tooltip_technologies_a-png.png" alt=""> </div>
    <div class="g-media_body">
     <p>When temperature is higher than set temperature, the motor rotates faster to lower room temperature.</p>
    </div>
   </div>
  </div>
  <div class="g-grid_el">
   <div class="g-media-h">
    <div class="g-media_left"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/common/images/tooltip_technologies_b-png.png" alt=""> </div>
    <div class="g-media_body">
     <p>Motor rotation speed is adjusted to maintain a constant temperature.</p>
    </div>
   </div>
  </div>
  <div class="g-grid_el">
   <div class="g-media-h">
    <div class="g-media_left"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/common/images/tooltip_technologies_c-png.png" alt=""> </div>
    <div class="g-media_body">
     <p>Motor rotates when temperature is higher than set temperature.</p>
    </div>
   </div>
  </div>
  <div class="g-grid_el">
   <div class="g-media-h">
    <div class="g-media_left"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/common/images/tooltip_technologies_d-png.png" alt=""> </div>
    <div class="g-media_body">
     <p>When temperature approaches set temperature, the motor rotation speed is reduced.</p>
    </div>
   </div>
  </div>
  <div class="g-grid_el">
   <div class="g-media-h">
    <div class="g-media_left"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/common/images/tooltip_technologies_e-png.png" alt=""> </div>
    <div class="g-media_body">
     <p>Motor stops when temperature is lower than set temperature.</p>
    </div>
   </div>
  </div>
  <div class="g-grid_el">
   <div class="g-media-h">
    <div class="g-media_left"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/common/images/tooltip_technologies_f-png.png" alt=""> </div>
    <div class="g-media_body">
     <p>Variation width for temperature becomes large when temperature is adjusted by repeatedly starting and stopping the motor. Furthermore, the motor always rotates at constant speed, and energy consumption increases from the energy loss of starting and stopping.</p>
    </div>
   </div>
  </div>
  <div class="g-grid_el">
   <div class="g-media-h">
    <div class="g-media_left"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/ac/common/images/tooltip_technologies_g-png.png" alt=""> </div>
    <div class="g-media_body">
     <p>Lowering motor rotation speed according to load reduces both variation width for temperature and energy consumption.</p>
    </div>
   </div>
  </div>
 </div>
          ...
          <div class="g-mb-40">
            <h3 class="g-ttl-3">Humidifying / Dehumidifying</h3>
            <p>Daikin technology manages humidity at any temperature without need for a water tank in providing users
              with the best in convenience and air comfort. (Ururu Sarara)</p>
            <h3 class="g-ttl-3">Heat Pump Performance</h3>
            <p>Both extremely hot and cold regions use and depend on the efficiency of heat pump technology to achieve
              energy savings.</p>
            <h3 class="g-ttl-3">Quiet Operation</h3>
            <p>Low operation sound has been achieved for greater comfort and quiet environment.</p>
          </div></div>
...
<div class="g-aside">
 <div class="g-sidebar">
  <div class="g-sidebar_hd"><a href="/products/ac/lineup/split_multi_split/products/ac/">Air Conditioning &amp; Refrigeration</a></div>
  <ul class="g-sidebar_lv1 g-box g-clearfix">
   <li class="g-sidebar_lv1_el g-sidebar_pc">
    <p class="g-sidebar_lv1_hd"><a href="/products/ac/lineup/split_multi_split/products/ac/">Air Conditioning &amp; Refrigeration <span class="g-sidebar_sp"> Top</span></a></p>
   </li>
   <li class="g-sidebar_lv1_el">
    <p class="g-sidebar_lv1_hd"> <a href="/products/ac/lineup/split_multi_split/products/ac/lineup/split_multi_split/">Split/Multi-Split</a> </p>
   </li>
   <li class="g-sidebar_lv1_el">
    <p class="g-sidebar_lv1_hd"> <a href="/products/ac/lineup/split_multi_split/products/ac/lineup/duct_unitary/">Unitary</a> </p>
   </li>
   <li class="g-sidebar_lv1_el">
 ...
 <div class="g-section g-section-recommend g-disp-pc">
  ...
  <div class="g-column">
   <ul class="g-hline g-hline-keep">
    <li class="g-hline_el"><a href="/products/ac/lineup/split_multi_split/air/" class="g-link" onclick="dataLayer.push({'event':'ev_track','evCategory':' We Recommend','evAction':'Side Navigation','evLabel':this.href.toString()});">Perfecting the Air</a></li>
    <li class="g-hline_el"><a href="/products/ac/lineup/split_multi_split/air/daikin_achievements/case_study/" class="g-link" onclick="dataLayer.push({'event':'ev_track','evCategory':' We Recommend','evAction':'Side Navigation','evLabel':this.href.toString()});">Case Study</a></li>
   </ul>
  </div>
 </div>
</div>
...
<a href="no-page/" class="g-hover">
<img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/common/images/pic_info_r32-jpg.jpg" alt="What's R-32?" class="g-img"></a></p>
 <div class="g-media_body">
  <h3 class="g-rmd_hd g-media_hd">What's R-32?</h3>
  <p class="g-media_text">R-32 is a next generation refrigerant that efficiently carries heat and has lower environmental impact.</p>
  <p><a href="no-page/" class="g-link">R-32 Next-Generation Refrigerant</a></p>
...
<div class="g-media-v">
 <p class="g-media_left"> <a href="no-page/" class="g-hover"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/common/images/pic_info_design-jpg.jpg" alt="Daikin Design" class="g-img"></a> </p>
 <div class="g-media_body">
  <h3 class="g-rmd_hd g-media_hd">Daikin Design</h3>
  <p class="g-media_text">Our wish is to make invisible air beloved.Here shows our initiatives and passion for Daikin designs.</p>
  <p><a href="no-page/" class="g-link">Daikin Design</a></p>
 </div>
</div></div>
...
<div class="g-grid g-grid-2c g-block">
 <div class="g-grid_el"><a href="/products/ac/lineup/split_multi_split/products/ac/services/" class="g-hover"><img src="assets/www.daikin.com/-/media/Project/Daikin/daikin_com/products/common/images/pic_related_services-jpg.jpg" alt="After Sales Service" class="g-img"></a> </div>
 <div class="g-grid_el">
  <p>A global support system delivers timely solutions to all needs.</p>
  <a href="/products/ac/lineup/split_multi_split/products/ac/services/" class="g-btn g-btn-em g-btn-inline">Learn More</a> </div>
</div>
          ...
          <hr class="g-hr">
          <div class="g-grid g-grid-2 g-block">
            <div class="g-grid_el g-mb-20">
              <h2 class="g-ttl-2">Related Products</h2>
              <div class="g-column">
                <ul class="g-vline g-mb-0">
                  <li class="g-vline_el"><a href="/products/ac/lineup/split_multi_split/products/ac/lineup/duct_unitary/" class="g-link">Unitary (Ducted Split)</a>
                  </li>
                  <li class="g-vline_el"><a href="no-page/" class="g-link">Air Purifiers</a></li>
                  <li class="g-vline_el"><a href="no-page/" class="g-link">Heating Systems</a></li>
                </ul>
              </div>
            </div>
            <div class="g-grid_el g-mb-20">
              <h2 class="g-ttl-2">Helpful Tips</h2>
              <div class="g-column">
                <p>For resolving problems and better performance, see the following.</p>
                <ul class="g-vline g-mb-0">
                  <li class="g-vline_el"><a href="no-page/"
                      class="g-link">Troubleshooting</a></li>
                  <li class="g-vline_el"><a href="no-page/" class="g-link">Maintenance
                      Tips</a></li>
                </ul>
              </div>
            </div>
...
<!--/probo_noindex--></div>
    ...
    <script src="/products/ac/lineup/split_multi_split/assets/maps.googleapis.com/maps/api/js/"></script>
