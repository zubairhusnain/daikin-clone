      ...
      bind() {
        ...
        if (this.airIdeal) {
          for (
            ...
            a.push(o[u].src);
          if ("mobile" === this.ua.getDevice().type) {
            a.some((e, t) => {
              -1 !== e.indexOf("img_ideal-image-slider-sp") && a.splice(t, 1);
            });
          }
          a.push(i.currentSrc),
            d(function* () {
              yield l("#js-progress", a);
              var e = yield Promise.all([r.e("vendor"), r.e("airIdeal")]).then(
                r.bind(null, 116)
              );
              yield e.default();
            })();
        ...
        this.slider &&
          d(function* () {
            var e = yield r.e("fadeInSlider").then(r.bind(null, 117));
            yield e.default();
          })();
      }
    })();
